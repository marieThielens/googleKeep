...
<body>
    <div class="d-flex align-items-center signUp">
        <div class="container border rounded my-auto text-center">
            <h2 class="text-center mt-4">Sign In</h2>
            <hr>

            <form action="main/login" method="post" autocomplete="off">
                <!-- Email -->
                ...
                <?= (isset($errors["emtyMail"])) ? "<p class='red'>".  $errors["emptyMail"] : ""?>
                <?= (isset($errors["exist"])) ? "<p class='red'>".  $errors["exist"] : ""?>
                ...
                <?= (isset($errors["wrongPassword"])) ? "<p class='red'>".  $errors["wrongPassword"] : ""?>
                
                <button type="submit" value="Sign Up" class="btn btn-primary col-12 mt-2">Log In</button>
                <p></p>
                <a class="exclude" href="main/signup">New here ? Click here to subscribe !</a>
            </form>
        </div>
    </div>
</body>
