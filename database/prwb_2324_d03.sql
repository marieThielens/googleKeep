...
--
-- Base de données : `prwb_2324_d03`
--
DROP DATABASE IF EXISTS `prwb_2324_d03`;
CREATE DATABASE IF NOT EXISTS `prwb_2324_d03` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `prwb_2324_d03`;
